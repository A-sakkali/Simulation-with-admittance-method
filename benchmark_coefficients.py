...
axs[0,0].plot(layers, abs(rs_s_te-rs_i_te), 'c-+', label="Admittence ", markersize=4)
...
axs[0,1].plot(layers, abs(rs_s_tm-rs_i_tm), 'c-+', label="Admittence", markersize=4)
...
axs[1,0].plot(layers, abs(ts_s_te-ts_i_te), 'c-+', label="Admittence", markersize=4)
...
axs[1,1].plot(layers, abs(ts_s_tm-ts_i_tm), 'c-+', label="Admittence", markersize=4)
...
plt.plot(layers, abs(ts_s_te-ts_a_te), 'b-v', label="abeles", markersize=4)
plt.plot(layers, abs(ts_s_te-ts_dn_te), 'r-o', label="D2N", markersize=4)
plt.plot(layers, abs(ts_s_te-ts_t_te), 'g-^', label="T", markersize=4)
plt.plot(layers, abs(ts_s_te-ts_i_te), 'c-+', label="Admittence", markersize=4)

plt.ylabel("Transmission absolute error TE Intermediate incidence")
...
# axs[0,0].plot(distances, abs(rs_s_te-rs_i_te), 'c-*', label="Admittence", markersize=4)
...
# axs[0,1].plot(distances, abs(rs_s_tm-rs_i_tm), 'c-*', label="Admittence", markersize=4)
...
plt.plot(distances, abs(ts_s_te-ts_a_te), 'b-v', label="abeles", markersize=4)
plt.plot(distances, abs(ts_s_te-ts_dn_te), 'r-o', label="D2N", markersize=4)
plt.plot(distances, abs(ts_s_te-ts_t_te), 'g-^', label="T", markersize=4)
plt.plot(distances, abs(ts_s_te-ts_i_te), 'c-*', label="Admittence", markersize=4)
plt.ylabel("Transmission absolute error TE TIR")
...
# axs[1,1].plot(distances, abs(ts_s_tm-ts_i_tm), 'c-*', label="Admittence", markersize=4)
...
for dist in distances:
    ...
    multi_stack1 = PM.Structure(materials,stack,epaisseurs, verbose=False, unit=unit, si_units=True)
    a = time()
    r_i,t_i, R_i,Ti = PM.coefficient_I(multi_stack1,wav,incidence,0)
    b = time()
    rs_i_te.append(R_i)
    ts_i_te.append(T_i)
...
axs[0,0].plot(distances, abs(rs_s_te-rs_t_te), 'g-^', label="T", markersize=4)
axs[0,0].plot(distances, abs(rs_s_te-rs_i_te), 'c-+', label="Admittence", markersize=4)
axs[0,0].set_ylabel("Reflection absolute error TE prism")
axs[0,0].set_xlabel("Distance (nm)")
...
axs[0,1].plot(distances, abs(rs_s_tm-rs_t_tm), 'g-^', label="T", markersize=4)
axs[0,1].plot(distances, abs(rs_s_tm-rs_i_tm), 'c-+', label="Admittence", markersize=4)
axs[0,1].set_ylabel("Reflection absolute error TM prism")
axs[0,1].set_xlabel("Distance (nm)")
...
axs[1,0].plot(distances, abs(ts_s_te-ts_i_te), 'c-+', label="Admittence", markersize=4)
axs[1,0].set_ylabel("Transmission absolute error TE prism")
...
axs[1,1].plot(distances, abs(ts_s_tm-ts_t_tm), 'g-^', label="T", markersize=4)
axs[1,1].plot(distances, abs(ts_s_tm-ts_i_tm), 'c-+', label="Admittence", markersize=4)
axs[1,1].set_ylabel("Transmission absolute error TM prism")
axs[1,1].set_xlabel("Distance (nm)")
# axs[1].set_ylim([1e-17,.25])
## axs[1].set_yscale("log")
axs[1,1].legend()
