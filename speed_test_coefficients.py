...
plt.plot(layers, times_a_tm, label="abeles")
plt.plot(layers, times_dn_tm,  label="D2N")
plt.plot(layers, times_s_tm,  label="S")
plt.plot(layers, times_t_tm,  label="T")
plt.plot(layers, times_i_tm, label="Admittence")
