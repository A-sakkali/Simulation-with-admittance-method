...
print(f"single interface and Impedance coeff trans in TE error = {np.format_float_scientific(abs(abs(t-t_i)/t), 2)}")
...
print(f"single interface and Impedance coeff trans in TM error = {np.format_float_scientific(abs(abs(t-t_i)/t), 2)}")
